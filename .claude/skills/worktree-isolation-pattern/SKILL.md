...
description: "The exact git worktree create, detect, and clean pattern for Aiclub workers: detect-or-create from main-repo-root, child worktree commands, branch naming conventions (feat/fix/chore), atomic commits, and .worktrees/ gitignore enforcement."
tags: [git, aiclub-specific, workflow, workers]
source: aiclub-authored 2026-05-16
risk: low
---
...
# /Users/adamks/VibeCoding/Aiclub                      abc1234 [main]
# /Users/adamks/VibeCoding/Aiclub/.worktrees/ceo-1-xxx  def5678 [ceo-1-xxx]
...
pnpm -F @aiclub/web exec tsc --noEmit apps/web/src/app/api/scan/route.ts

# Lint
pnpm -F @aiclub/web lint --max-warnings 0
```
...
# Run relevant tests
pnpm -F @aiclub/web test -- --testPathPattern="scan"
...
```json
{
  ...
  "worktree": "/Users/adamks/VibeCoding/Aiclub/.worktrees/scan-rate-limit",
  "files_changed": [
