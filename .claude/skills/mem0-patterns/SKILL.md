...
description: "Mem0 episodic memory write/read patterns for Aiclub agents: mandatory metadata fields, retry policy, and fallback to Anthropic Memory Tool after 3 failures. Use when any C-suite or lead agent reads or writes episodic memory during pre-flight or post-task."
tags: [memory, aiclub-specific, agents, ai]
...
Every Mem0 write MUST include all four fields. Writes missing any of these are rejected by the Aiclub wrapper.
...
- `pgvector-rag-aiclub` — [[pgvector-rag-aiclub]]
