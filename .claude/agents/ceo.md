...
**Hard rule: chiefs are mandatory in T2.** Their expertise + planning is the Aiclub value layer. Never skip a chief to save tokens — the savings come from staying at T2 instead of escalating to T3, not from skipping the chief.
