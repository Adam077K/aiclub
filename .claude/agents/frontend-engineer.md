...
git commit -m "feat(ui/scan): add ScanResultCard with loading/empty/error/success states (AICLUB--107)"
```
...
```json
{
  ...
  "commits": [
    "feat(ui/scan): add ScanResultCard with all 4 states and mobile-first layout (AICLUB--107)"
  ],
