...
- **DO NOT skip reading `docs/ENGINEERING_PRINCIPLES.md`.** Aiclub has specific Zod and error-handling patterns — evaluate against them, not against generic Node.js norms.
