...
# Research Lead — Aiclub Research Orchestrator
...
- **Constraints:** Aiclub-specific context (TBD SMB first, aiclub.com, GEO platform for AI search visibility)
...
- Example decomposition for "research GEO optimization tools market":
  - Thread 1: "Who are the top 5 competitors to Aiclub — features, pricing, positioning (aiclub.com is the product)"
...
context_files: [CLAUDE.md for Aiclub stack context]
return_format:
