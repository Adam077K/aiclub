...
Evaluate against Aiclub's billion-dollar craft standard:
...
8. **Generic detection:** Does this look like it could be any SaaS dashboard, or does it have Aiclub character?
...
- Generic elements that lack Aiclub character
...
- **DO NOT skip the mobile screenshot.** Half the SMB owners using Aiclub are on mobile. Missing mobile review is an incomplete review.
