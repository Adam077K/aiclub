...
description: "Aiclub billing patterns using Paddle: webhook signature verification, checkout session creation, customer portal URL generation, price ID conventions, and subscription lifecycle. Stripe is not used — Paddle is the only payment provider."
tags: [billing, aiclub-specific, backend, payments]
...
- Stripe is not in the Aiclub stack. Any Stripe reference is legacy and should be removed.
...
- `supabase-rls-aiclub` — [[supabase-rls-aiclub]]
