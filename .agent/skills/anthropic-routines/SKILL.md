...
description: "How to write a Aiclub Routine .md file: required frontmatter fields (schedule, routine_id_env_key, budget, trust-spec parsing), body conventions, and MCP grant patterns. Use when authoring or refining any file under .claude/agents/_routines/."
tags: [orchestration, aiclub-specific, agents, routines]
...
1. Extract spec from `---AICLUB--SPEC-V1-START---` / `---AICLUB--SPEC-V1-END---` sentinels
